        ...
        <div className="about-us-container text-center" style={{ position: 'relative', zIndex: 2 }}>
          ...
          <div className="contact-info-flex">
            <div className="contact-item">
              ...
              <h4>Our Location</h4>
              <p>8P4M+GQ, Appayanaickenpatti,<br />Sevalpatti, Tamil Nadu 626140</p>
            </div>
            <div className="contact-item">
          ...
          <a href="https://wa.me/918525858075" target="_blank" rel="noopener noreferrer" className="btn-whatsapp-large">
